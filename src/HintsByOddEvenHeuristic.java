...
public class HintsByOddEvenHeuristic {
	...
	public HashMap<Integer, ArrayList<String>> getNumProperties()
	{
		...
		System.exit(0);
			...
			File queryStringFile = new File("sparkle_odd_even");
			String queryString = extractText(queryStringFile);

			Model model = null;

			{
				model = readModelFromFile("RDF_ODD_EVEN");
	...
	public static void main(String[] args)
	{
		...
		new HintsByOddEvenHeuristic().getNumProperties();
	}
}
